 ...
 * This file contains the declarations of functions and structures related to Prim's 
 * algorithm.
...
/******************************************************************************************
 * @brief Find the index of the node with the minimum cost that is not yet included in 
 * the MST.
 * This function takes an array of costs and a boolean array indicating whether a node 
 * is already
 * included in the MST. It returns the index of the node with the minimum cost that is 
 * not yet included
 * in the MST.
 * 
 ...
 * 
 * This function takes a graph and returns the minimum spanning tree (MST) using Prim's 
 * algorithm.
 ...
 * 
 * This function takes a graph, an array of predecessors, and an array of costs, and prints
 * the minimum
